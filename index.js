...
(function () {
  ...
  // Set up gyroscope control ControlMethod if on mobile
  var deviceOrientationControlMethod = new DeviceOrientationControlMethod();
  var controls = viewer.controls(); // Need this earlier
  ...
  function toggleGyro() {
    if (gyroToggleElement.classList.contains('enabled')) {
      disableGyro();
    } else {
      enableGyro();
    }
  ...
  // var controls = viewer.controls(); // Moved up
